...
const BenefitCard: React.FC<BenefitCardProps> = ({
  ...
  <div className="flex flex-col md:flex-row items-start gap-4 md:gap-10">
    ...
    <div>
      ...
      <p
        className={`text-gray-600 mb-4 leading-relaxed text-sm sm:text-base md:text-lg ${
          isKhmer ? "khmer-font" : ""
        }`}
      >
        {description}
      ...
      <button
        className={`px-4 sm:px-5 py-2 text-sm sm:text-base font-semibold text-white bg-[#1B1D4E] rounded-full hover:bg-[#03057f] transition ${
          isKhmer ? "khmer-font" : ""
        }`}
      >
