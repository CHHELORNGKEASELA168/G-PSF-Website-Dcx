...
const makeWorkGroups = (): Record<Lang, WorkGroup[]> => ({
    ...
    kh: [
        { id: 1, title: "កសិកម្ម និងឧស្សាហកម្មកសិកម្ម", icon: <Sprout size={32} className="md:w-10 md:h-10" /> },
        { id: 2, title: "ទេសចរណ៍", icon: <Palmtree size={32} className="md:w-10 md:h-10" /> },
        { id: 3, title: "ឧស្សាហកម្មផលិត និងសហគ្រាស SME", icon: <Settings size={32} className="md:w-10 md:h-10" /> },
        { id: 4, title: "ច្បាប់ ពន្ធ និងអភិបាលកិច្ច", icon: <Scale size={32} className="md:w-10 md:h-10" /> },
        { id: 5, title: "ធនាគារ និងសេវាហិរញ្ញវត្ថុ", icon: <Building2 size={32} className="md:w-10 md:h-10" /> },
        { id: 6, title: "ដឹកជញ្ជូន និងហេដ្ឋារចនាសម្ព័ន្ធ", icon: <Bus size={32} className="md:w-10 md:h-10" /> },
        { id: 7, title: "ដំណើរការនាំចេញ និងសម្របសម្រួលពាណិជ្ជកម្ម", icon: <Ship size={32} className="md:w-10 md:h-10" /> },
        { id: 8, title: "ទំនាក់ទំនងឧស្សាហកម្ម", icon: <Factory size={32} className="md:w-10 md:h-10" /> },
        { id: 9, title: "ស្រូវ-អង្ករ", icon: <Wheat size={32} className="md:w-10 md:h-10" /> },
        { id: 10, title: "ថាមពល និងធនធានរ៉ែ", icon: <Zap size={32} className="md:w-10 md:h-10" /> },
        { id: 11, title: "អប់រំ", icon: <GraduationCap size={32} className="md:w-10 md:h-10" /> },
        { id: 12, title: "សុខាភិបាល", icon: <Heart size={32} className="md:w-10 md:h-10" /> },
        { id: 13, title: "សំណង់ និងអចលនទ្រព្យ", icon: <Home size={32} className="md:w-10 md:h-10" /> },
        { id: 14, title: "សេវាហិរញ្ញវត្ថុមិនមែនធនាគារ", icon: <Landmark size={32} className="md:w-10 md:h-10" /> },
        { id: 15, title: "សេដ្ឋកិច្ចឌីជីថល សង្គម និងទូរគមនាគមន៍", icon: <MonitorSmartphone size={32} className="md:w-10 md:h-10" /> },
        { id: 16, title: "រដ្ឋបាលដីធ្លី សន្តិសុខ និងសណ្តាប់ធ្នាប់សាធារណៈ", icon: <ShieldCheck size={32} className="md:w-10 md:h-10" /> },
    ],
});
