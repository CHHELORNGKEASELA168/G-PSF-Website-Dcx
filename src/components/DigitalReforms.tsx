    ...
    return (
        <>
            ...
            <div className="text-center mb-90 mt-32">
                ...
                <p className="mt-4 text-2xl text-gray-500 max-w-4xl mx-auto">
                    ...
                    >
                        {contentItems.map((item, index) => (
                            <SwiperSlide key={index} className="pb-15 pt-16 px-[10px]">
                                <div className="rounded-tl-[120px] bg-white overflow-hidden rounded-bl-[25px] rounded-br-[25px] relative pt-12 h-[390px] pb-10 flex flex-col" style={{ boxShadow: '0 7px 15px rgba(0,0,0,0.4)' }}>
                                    <div
